...
export type GetMoveTransfersQueryVariables = Exact<{
  epochId?: InputMaybe<Scalars['UInt53']['input']>;
  cursor?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetMoveTransfersQuery = { __typename?: 'Query', epoch?: { __typename?: 'Epoch', totalTransactions?: any | null, startTimestamp: any, endTimestamp?: any | null, transactionBlocks: { __typename?: 'TransactionBlockConnection', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, endCursor?: string | null }, nodes: Array<{ __typename?: 'TransactionBlock', digest?: string | null, effects?: { __typename?: 'TransactionBlockEffects', status?: ExecutionStatus | null, events: { __typename?: 'EventConnection', nodes: Array<{ __typename?: 'Event', json: any, timestamp?: any | null, type: { __typename?: 'MoveType', repr: string }, sendingModule?: { __typename?: 'MoveModule', name: string, package: { __typename?: 'MovePackage', defaultSuinsName?: string | null, address: any } } | null }> } } | null }> } } | null };


export const GetMoveTransfersDocument = gql`
    query getMoveTransfers($epochId: UInt53, $cursor: String) {
  epoch(id: $epochId) {
    totalTransactions
    startTimestamp
    endTimestamp
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getMoveTransfers(variables?: GetMoveTransfersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetMoveTransfersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetMoveTransfersQuery>(GetMoveTransfersDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getMoveTransfers', 'query', variables);
    }
  };
}
